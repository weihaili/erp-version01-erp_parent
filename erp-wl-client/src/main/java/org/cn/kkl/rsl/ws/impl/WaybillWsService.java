 ...
 * 
 */
@WebServiceClient(name = "WaybillWsService", targetNamespace = "http://impl.ws.rsl.kkl.cn.org/", wsdlLocation = "http://localhost:8090/redsun/ws/waybill?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WAYBILLWSSERVICE_QNAME = new QName("http://impl.ws.rsl.kkl.cn.org/", "WaybillWsService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8090/redsun/ws/waybill?wsdl");
    ...
    public IWaybillWs getWaybillWsPort() {
        return super.getPort(new QName("http://impl.ws.rsl.kkl.cn.org/", "WaybillWsPort"), IWaybillWs.class);
    }
    ...
    public IWaybillWs getWaybillWsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.ws.rsl.kkl.cn.org/", "WaybillWsPort"), IWaybillWs.class, features);
    }
